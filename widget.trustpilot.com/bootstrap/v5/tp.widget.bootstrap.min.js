    ...
    3: [function(e, t, i) {
        ...
        t.exports = function(e) {
            ...
            if (e.sku) {
                ...
                if ((e.templateId === m.productReviewsSEO || e.templateId === m.productReviewsMultiSourceSEO) && e.name || u && "Product" === e.schemaType) return l = (a = e).businessunitId, r = a.locale, e = a.templateId, t = a.name, i = a.sku, d = a.reviewnumber, n = a.price, o = a.priceCurrency, a = a.availability, r = r && r.split("-")[0], l = "https://widget.trustpilot.com" + (e === m.productReviewsMultiSourceSEO ? "/data/jsonld/business-unit/" + l + "/product-imported" : "/data/jsonld/business-unit/" + l + "/product") + "?sku=" + encodeURIComponent(i) + "&numberOfReviews=" + (d || 10) + (t ? "&productName=" + encodeURIComponent(t) : "") + "&language=" + r + "&templateId=" + e + "&url=" + encodeURIComponent(window.location.origin + window.location.pathname), s = n && o && a ? {
                    "@type": "Offer",
                    priceCurrency: o,
                    price: n,
                    availability: a
                    ...
                    url: l,
                    success: function(e) {
                        s && (e.offers = s), (e.offers || e.review || e.aggregateRating) && h(e)
                    },
                    error: function(e) {
                        console.error(e)
                    }
