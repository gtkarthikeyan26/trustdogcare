! function r(o, i, a) {
    ...
    1: [function(e, t, n) {
        "use strict";
        (0, e("@trustpilot/trustbox-micro-framework").microCombo)()
    }, {
    ...
    28: [function(e, t, n) {
        ...
        e = e("./trustboxes");
        n.microCombo = e.microCombo, e.microReviewCount, e.microStar, e.microTrustScore
    }, {
        "./trustboxes": 30
    }],
    2: [function(e, t, n) {
        ...
        n.apiCall = function(o, i) {
            return new Promise(function(e, t) {
                var n = void 0,
                    r = void 0;
                if (0 === o.indexOf("/") && (n = i || {}, (0, s.getAsObject)().token && (n.random = function(e) {
    ...
    25: [function(e, t, n) {
        ...
        Object.defineProperty(n, "__esModule", {
            ...
            "GET" === i.type && i.data && (i.url = i.url + "?" + function(e) {
                ...
                return n.join("&")
            }(i.data), delete i.data), a() && a() <= 9 ? (r = i, o = new window.XDomainRequest, e = window.location.protocol, r.url = r.url.replace(/https?:/, e), o.open(r.type, r.url), o.onload = function() {
                r.success(s(o))
            }, o.onerror = function() {
                r.error(s(o))
            }, setTimeout(function() {
                o.send(r.data)
            }, 0)) : (t = i, (n = new(window.XMLHttpRequest || ActiveXObject)("MSXML2.XMLHTTP.3.0")).open(t.type, t.url, !0), n.setRequestHeader("Content-type", "application/x-www-form-urlencoded"), n.onreadystatechange = function() {
    ...
    3: [function(e, t, n) {
        ...
        n.fetchData = function(a) {
            return function(e, t, n, r) {
                var o, i, e = (i = e, (o = h) in (e = {}) ? Object.defineProperty(e, o, {
                    value: i,
                    enumerable: !0,
                    configurable: !0,
                    writable: !0
    ...
    24: [function(e, t, n) {
        ...
        "./dom": 11,
        "./models/styleAlignmentPositions": 15,
        "./rootUri": 17
    }],
    10: [function(e, t, n) {
        "use strict";
        ...
        function c(e) {
            ...
            if ("string" == typeof e.data) {
                ...
                if ("setId" === t.data.command) a = t.data.widgetId,
                    function() {
    ...
    18: [function(e, t, n) {
        ...
        n.errorFallback = function() {
            ...
            (0, r.populateElements)([{
                ...
                }, (0, o.mkElemWithSvgLookup)("logo", "fallback-logo"))
            }])
    ...
    19: [function(e, t, n) {
        ...
        n.withLoader = function(e) {
            ...
            return e.finally(function() {
                var e, t;
                clearTimeout(o), e = r, t = document.getElementById(e), (0, i.addClass)(t, e + "--loaded"), t && (t.addEventListener("animationend", function() {
        ...
        o(u, [{
            ...
            value: function() {
                var t = this,
                    ...
                    e = (0, a.pipeMaybe)((0, a.guard)(this.includeImportedReviews), (0, a.propMaybe)("importedProductReviews"), (0, a.propMaybe)("productReviews"), (0, a.map)(function(e) {
                        return r({}, e, {
            ...
            value: function() {
                var e = (0, s.getNextPageLinks)(function(e) {
                        return (0, a.pipeMaybe)((0, a.prop)(e), (0, a.prop)("links"), (0, a.find)(function(e) {
    ...
    9: [function(e, t, n) {
        ...
        function a(e, t) {
            var n, r = t.dimensionId,
                o = t.color,
                t = t.rating;
            return '\n  <svg role="img" aria-labelledby="scaleRating" xmlns="http://www.w3.org/2000/svg" fill="none" viewBox="0 0 ' + e.width + " " + e.height + '">\n      <g class="tp-stars">\n        ' + (n = o, m[r].lines.reduce(function(e, t) {
    ...
    11: [function(e, t, n) {
        ...
        Object.defineProperty(n, "__esModule", {
            value: !0
        }), n.populateElements = n.addClass = void 0;
        var r = e("./utils");
    ...
    13: [function(e, t, n) {
        ...
        function f(e, t) {
            var n = t.session,
                ...
                t = i.group,
                i = i.businessunitId;
            t && o && (i = "TrustboxSplitTest_" + i, t = encodeURIComponent(JSON.stringify({
                group: t,
                session: n,
                testId: r
            })), n = o, r = "path=/", o = "domain=" + window.location.hostname.replace(/^.*\.([^.]+\.[^.]+)/, "$1"), document.cookie = [i + "=" + t, r, n, o, "samesite=none", "secure"].join("; "), document.cookie = [i + "-legacy=" + t, r, n, o].join("; "))
        }

        function i(e, t) {
            f(0, t);
            var n, r, o, i, a, r = (n = e, o = (r = t).anonymousId, r.sessionExpiry, i = d(r, ["anonymousId", "sessionExpiry"]), t = (e = (0, l.getAsObject)()).businessunitId, r = e.templateId, e = d(e, ["businessunitId", "templateId"]), a = s({}, e, i, e.group && o ? {
                userId: o
            } : {
                nosettings: 1
            }, {
            ...
            attachImpressionHandler: function() {
                (0, r.addEventListener)(window, "message", function(e) {
                    if ("string" == typeof e.data) {
                        ...
                        if ("setId" === t.data.command) return a = t.data.widgetId, void window.parent.postMessage(JSON.stringify({
                            command: "impression",
                            widgetId: a
                        }), "*");
    ...
    23: [function(e, t, n) {
        ...
        Object.defineProperty(n, "__esModule", {
            value: !0
        }), n.mkElemWithSvgLookup = n.span = n.div = n.a = void 0;
        ...
        var o, a = e("./assets/svg"),
            s = e("./utils"),
            l = r("a"),
            u = r("div"),
            e = (r("img"), r("label"), r("span"));
        o = "input";
        n.a = l, n.div = u, n.span = e, n.mkElemWithSvgLookup = function(e) {
            return u({
                class: 1 < arguments.length && void 0 !== arguments[1] ? arguments[1] : ""
            }, a.svgMap[e](arguments[2]))
        }
    }, {
        "./assets/svg": 9,
        "./utils": 24
    ...
    20: [function(e, t, n) {
        ...
        Object.defineProperty(n, "__esModule", {
            value: !0
        }), n.populateLogo = n.makeLogo = void 0;
        ...
        var o = e("../templating"),
            i = e("../dom");
        n.makeLogo = r, n.populateLogo = function() {
    ...
    21: [function(e, t, n) {
        ...
        Object.defineProperty(n, "__esModule", {
            value: !0
        }), n.populateStars = n.makeStars = void 0;
        ...
        function i(e) {
            ...
            return (0, a.div)({
                class: r
            }, (0, a.mkElemWithSvgLookup)("stars", o ? "tp-stars-custom-color" : "tp-stars tp-stars--" + i + e, {
                rating: t,
                trustScore: n || t,
                color: o
            }))
        ...
        var a = e("../templating"),
            s = e("../dom"),
            l = e("../utils");
        n.makeStars = i, n.populateStars = function(e) {
    ...
    22: [function(e, t, n) {
        ...
        Object.defineProperty(n, "__esModule", {
            value: !0
        }), n.ORIENTATION = n.makeEmptySummary = void 0;
        ...
        n.makeEmptySummary = function(e) {
            return e.orientation === d.HORIZONTAL ? (t = e, n = e.title, r = e.url, t = e.nofollow, n = (0, l.makeTranslations)({}, n), (0, i.div)({
                ...
                href: r,
                target: "_blank"
            }, u(t)), (0, s.makeLogo)()))) : (t = e, e = (0, l.makeTranslations)({}, t.title), t = c(t), (0, i.div)({
    ...
    26: [function(e, t, n) {
        ...
        n.default = function(e) {
            function t(e) {
                ...
                t.settings.customStylesAllowed && (f && (0, h.setFont)(f), p && (0, h.setTextColor)(p), v && (r = v, L.widgetStyleAlignment.includes(r) && (o = "tp-widget-wrapper", document.getElementById(o).classList.add(o + "--" + r))));
                var r, o = m({}, t, {
                    styleAlignment: v,
                    strings: e,
                ...
                0 === t.businessEntity.numberOfReviews.total ? (r = x(i, t.links.evaluateUrl), e = x(i, t.links.profileUrl), l(o, r, e)) : (a(o), s(o), function(e, t) {
                    t = x(e, t);
            ...
            (0, b.default)(function() {
                return (0, y.fetchServiceReviewData)(d)({
                    businessUnitId: o,
                    locale: r,
                    theme: u,
                    location: c
    ...
    27: [function(e, t, n) {
        ...
        n.default = function() {
            return {
                rating: new s("tp-widget-rating"),
                stars: new s("star-container"),
                score: new s("trust-score"),
                translations: new s("translations-main"),
                wrapper: new u("tp-widget-wrapper")
            }
        }
    }, {
        "@trustpilot/trustbox-framework-vanilla/modules/utils": 24
    ...
    30: [function(e, t, n) {
        ...
        var r, o = e("./constructor"),
            ...
            s = e("@trustpilot/trustbox-framework-vanilla/modules/templates/stars"),
            l = e("@trustpilot/trustbox-framework-vanilla/modules/templates/logo"),
            u = e("@trustpilot/trustbox-framework-vanilla/modules/templates/summary");
        ...
        function c(e, t) {
            var n = e.elements.wrapper,
                ...
                t = {
                    ...
                    title: e.firstreviewer,
                    url: t
                },
                t = (0, u.makeEmptySummary)(t);
            n.setHtml(t)
        }
        n.microCombo = function() {
            (0, i.default)({
                name: "MicroCombo",
                setup: function(e) {
                    (0, l.populateLogo)(), (0, s.populateStars)(e, "tp-widget-stars")
                },
                withReviews: function(e) {
                    var t = e.elements,
                        ...
                        o = e.strings,
                        t = e.formatNumber,
                        e = e.businessEntity.numberOfReviews.total;
                    n.setHtml(o.rating), r.setHtml((0, a.makeTranslations)({
                        "[NOREVIEWS]": t(e)
                    }, o.main))
                },
                withoutReviews: c
